...
FocusListener {
    ...
    private void Class_Initialize() {
        ...
        try {
            ...
            Me.myDefaultBorder = Me.$Parent().getBorder();
            Me.$Parent().setMargin(new Insets(1, 5, 1, 1));
            return;
        }
        catch (Throwable throwable) {
            Object var2_2 = null;
    ...
    public void $BorderStyle(fmBorderStyle v) {
        ...
        try {
            ...
            if (v.compareTo(fmBorderStyle.fmBorderStyleNone) == 0) {
                Me.$Parent().setBorder(null);
                return;
            }
            Me.$Parent().setBorder(Me.myDefaultBorder);
            return;
        }
        catch (Throwable throwable) {
            Object var3_3 = null;
    ...
    public void $Text(String s) {
        ...
        try {
            PasswordField Me;
            ((JTextComponent)Me.$Parent()).setText(s);
            return;
        }
        catch (Throwable throwable) {
            Object var3_3 = null;
