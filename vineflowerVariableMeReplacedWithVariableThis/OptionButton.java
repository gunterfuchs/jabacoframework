...
public class OptionButton extends JRadioButton implements VB.IJabacoControl, MouseListener, MouseMotionListener, KeyListener, ActionListener, FocusListener {
   ...
   public JRadioButton $Parent() {
      JRadioButton $Parent = null;
      Throwable Err = null;
