...
public class PasswordField extends JPasswordField implements VB.IJabacoControl, MouseListener, MouseMotionListener, KeyListener, FocusListener {
   ...
   public JPasswordField $Parent() {
      JPasswordField $Parent = null;
      Throwable Err = null;
   ...
   private void Class_Initialize() {
      ...
      try {
         ...
         $Parent().setMargin(new Insets(1, 5, 1, 1));
