...
FocusListener {
    ...
    private void Class_Initialize() {
        ...
        try {
            Me.$Parent().setVerticalAlignment(SwingConstants.TOP);
        }
        catch (Throwable throwable) {
            var2_2 = null;
            Err = throwable;
     ...
     * Enabled aggressive exception aggregation
     */
    public fmTextAlign $TextAlign() {
        fmTextAlign $TextAlign = new fmTextAlign();
        Throwable Err = null;
        int h5 = 0;
        h5 = 0;
        try {
            Label Me;
            h5 = Me.$Parent().getHorizontalAlignment();
            if (h5 == SwingConstants.LEFT) {
                return fmTextAlign.fmTextAlignLeft;
            }
            if (h5 == SwingConstants.CENTER) {
                return fmTextAlign.fmTextAlignCenter;
            }
            if (h5 == SwingConstants.RIGHT) return fmTextAlign.fmTextAlignRight;
            return $TextAlign;
        }
        catch (Throwable throwable) {
            Object var3_4 = null;
     ...
     * Enabled aggressive exception aggregation
     */
    public void $TextAlign(fmTextAlign val) {
        Throwable Err = null;
        fmTextAlign h5 = new fmTextAlign();
        h5 = null;
        try {
            Label Me;
            h5 = val;
            if (h5.compareTo(fmTextAlign.fmTextAlignLeft) == 0) {
                Me.$Parent().setHorizontalAlignment(SwingConstants.LEFT);
                return;
            }
            if (h5.compareTo(fmTextAlign.fmTextAlignCenter) == 0) {
                Me.$Parent().setHorizontalAlignment(SwingConstants.CENTER);
                return;
            }
            if (h5.compareTo(fmTextAlign.fmTextAlignRight) != 0) {
                return;
            }
            boolean bl = true;
            if (!bl) {
            ...
            Me.$Parent().setHorizontalAlignment(SwingConstants.RIGHT);
            return;
        }
        catch (Throwable throwable) {
            Object var3_4 = null;
    ...
    private void SetMyBorder() {
        ...
        try {
            Label Me;
            Me.$Parent().setBorder(Global.GetVBBorder(Me.$BorderStyle(), Me.$SpecialEffect(), Me.$BorderColor()));
            return;
        }
        catch (Throwable throwable) {
            Object var2_2 = null;
    ...
    public void $Picture(IResource Path) {
        block4: {
            ...
            try {
                ...
                Me.$Parent().setIcon(Global.LoadIcon(Me.myPicturePath));
            }
            catch (Throwable throwable) {
                Object var3_3 = null;
                Err = throwable;
