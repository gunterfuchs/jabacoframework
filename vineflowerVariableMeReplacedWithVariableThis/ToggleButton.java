...
public class ToggleButton extends JToggleButton implements VB.IJabacoControl, MouseListener, MouseMotionListener, KeyListener, ActionListener, FocusListener {
   ...
   public void $Picture(IResource param1) {
      ...
      // 1b: aload 0
      // 1c: aload 1
      // 1d: putfield VB/ToggleButton.myPicturePath LVBA/IResource;
      // 20: aload 0
      // 21: aload 0
      // 22: getfield VB/ToggleButton.myPicturePath LVBA/IResource;
   ...
   public void $RolloverPicture(IResource param1) {
      ...
      // 1b: aload 0
      // 1c: aload 1
      // 1d: putfield VB/ToggleButton.myRolloverPicturePath LVBA/IResource;
      // 20: aload 0
      // 21: bipush 1
      // 22: invokespecial javax/swing/AbstractButton.setRolloverEnabled (Z)V
      // 25: aload 0
      // 26: aload 0
      // 27: getfield VB/ToggleButton.myRolloverPicturePath LVBA/IResource;
